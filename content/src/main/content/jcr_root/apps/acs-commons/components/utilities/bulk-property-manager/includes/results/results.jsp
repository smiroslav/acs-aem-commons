...
<div ng-controller="ResultsCtrl"
    ...
    <p>Download the results from Bulk Property updates below.</p>
    ...
    <table class="data" style="width: 100%">
        ...
        <tbody>
            <tr ng-repeat="result in results | orderBy : 'result.name * 1' : true ">
            ...
            <tr ng-show="results && result.length < 1">
                <td colspan="8">There are no results.</td>
            </tr>
        </tbody>
    </table>
