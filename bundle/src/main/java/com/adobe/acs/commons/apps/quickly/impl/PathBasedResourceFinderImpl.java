...
import com.adobe.acs.commons.apps.quickly.PathBasedResourceFinder;
import com.adobe.acs.commons.apps.quickly.results.ResultUtil;
...
public class PathBasedResourceFinderImpl implements PathBasedResourceFinder {
    ...
    public static final int DEFAULT_MIN_NODE_NAME_LOOKUP_LENGTH = 2;
    ...
    @Override
    public final List<Resource> findAll(final ResourceResolver resourceResolver, final String pathFragment,
    ...
    @Override
    public final List<Resource> findByAbsolutePath(final ResourceResolver resourceResolver, final String path) {
        final long start = System.currentTimeMillis();
    ...
    @Override
    public final List<Resource> findByAbsolutePathPrefix(final ResourceResolver resourceResolver, final String path) {
        final long start = System.currentTimeMillis();
    ...
    @Override
    public final List<Resource> findByPathFragment(final ResourceResolver resourceResolver, final String pathFragment,
                                                   final int limit, final String... nodeTypes) {
        final long start = System.currentTimeMillis();
    ...
    @Override
    public final List<Resource> findByWildCardFragment(final ResourceResolver resourceResolver,
    ...
    @Override
    public final List<Resource> findByNodeName(final ResourceResolver resourceResolver, final String nodeName,
    ...
    public final List<Resource> getChildren(final boolean includeParent, final Resource parent,
    ...
    public final List<Resource> getChildren(final boolean includeParents, final Collection<Resource> parents,
                                            final String relPath) {
        final List<Resource> results = new ArrayList<Resource>();
    ...
    @Activate
    private void activate(final Map<String, String> config) {
