...
public final class LastModifiedUtil {
    ...
    public static long getLastModifiedTimestamp(final ResourceResolver resourceResolver, final String path) {
        final Resource resource = resourceResolver.getResource(path);

        return getLastModifiedTimestamp(resource);
    }

    public static long getLastModifiedTimestamp(final Resource resource) {
    ...
    public static String getLastModifiedBy(final ResourceResolver resourceResolver, final String path) {
        final Resource resource = resourceResolver.getResource(path);
        return getLastModifiedBy(resource);
    }

    public static String getLastModifiedBy(final Resource resource) {
        final ValueMap properties = resource.adaptTo(ValueMap.class);
    ...
    private static long findMax(final long... values) {
        long max = 0;
